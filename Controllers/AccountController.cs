...
{ 
    ...
    public IActionResult Create()
            ...
            if(ModelState.IsValid)
            {
                ...
                {   
                    ...
                    var url = Url.Action("ConfirmEmail" ,"Account", new{user.Id, token});
                     ...
                     await _emailSender.SendEmailAsync(user.Email, "Hesap Onayı", $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:5288{url}'>tıklayınız.</a>");

                    TempData["message"] = "Emailinize gönderilen onay mailine tıklayın";
         ...
         public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            await _emailSender.SendEmailAsync(Email,"Parola Sıfırlama ", $"Parolanızı yenilemek için linke  <a href='https://localhost:5288{url}'> tıklayınız. </a>.");

            TempData["message"] = "Eposta adresinize gönderilen link ile şifrenizi sıfırlayınız.";
